...
from iglovikov_helper_functions.dl.catalyst.metrics import calculate_confusion_matrix_from_arrays_fast
...
def test_confusion_matrix():
    ...
    normal_cm = calculate_confusion_matrix_from_arrays_fast(y_true, y_pred, num_classes=num_classes)
